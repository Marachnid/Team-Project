...
public class ProfileServices {
                ...
                content = @Content(
                    ...
                    examples = {
                        @ExampleObject(
                            ...
                            value = "[{\"id\": \"1\", \"age\": \"30\", \"height\": \"70\", \"weight\": \"160\", \"sexType\": \"male\", \"activity\": \"1.725\"}," +
                                    "{\"id\": \"2\", \"age\": \"31\", \"height\": \"65\", \"weight\": \"130\", \"sexType\": \"female\", \"activity\": \"1.3\"}]")})
            ),
            @ApiResponse(
                responseCode = "500",
    ...
    public Response getAllProfiles() {
        ...
        if (profiles == null || profiles.isEmpty()) {
            ...
            logger.info("{} profiles found", profiles.size());
        }
    ...
    public Response getProfileById(
            @Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "The ID of the profile to retrieve", example = "1") @PathParam("id") int id)
    {
     ...
     */
    @POST
    @Path("/{age}/{height}/{weight}/{sexType}/{activity}")
    @Operation(
                ...
                content = @Content(
                    ...
                    examples = {
                        @ExampleObject(
                            ...
                            value = "{ \"id\": \"1\", \"age\": \"30\", \"height\": \"175.0\", \"weight\": \"160.0\", \"sex\": \"male\", \"activity\": \"1.2\" }")})
            ),
            @ApiResponse(
                responseCode = "500",
                description = "Internal server error")
    ...
    public Response addProfile(
            ...
            @Parameter(name = "activity", in = ParameterIn.PATH, required = true, description = "Activity multiplier (e.g., 1.2 for sedentary, 1.9 for very active)",
                    example = "1.2") @PathParam("activity") double activity)
    {
     ...
     */
    @PUT
    @Path("/{id}/{age}/{height}/{weight}/{sexType}/{activity}")
    @Operation(
                ...
                content = @Content(
                    ...
                    examples = {
                        @ExampleObject(
                            ...
                            value = "{ \"id\": \"1\", \"age\": \"35\", \"height\": \"178.0\", \"weight\": \"165.0\", \"sex\": \"female\", \"activity\": \"1.4\" }")})
            ),
            @ApiResponse(
                responseCode = "404",
                description = "Profile not found"),
    ...
    public Response updateProfile(
            @Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "ID of the profile to update", example = "1") @PathParam("id") int id,
            ...
            @Parameter(name = "activity", in = ParameterIn.PATH, required = true, description = "Activity multiplier (e.g., 1.2 for sedentary, 1.9 for very active)",
                    example = "1.4") @PathParam("activity") double activity)
    {
    ...
    public Response deleteProfile(
            @Parameter(name = "id", in = ParameterIn.PATH, required = true, description = "ID of the profile to delete", example = "1") @PathParam("id") int id)
    {
